...
{
    public partial class Moto_Honda : FrmBaseModelo
    {
        ...
        private void Moto_Honda_Load(object sender, EventArgs e)
        {//agrego elementos al combobox del modelo
            combomodelo.Items.Clear();
            combomodelo.Items.Add("Honda PCX125");
            combomodelo.Items.Add("Honda NT1100");
        ...
        private void btnsolicitar_Click(object sender, EventArgs e)
        {
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.Honda_PCX_Negra;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "18,450";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.Honda_PCX_Blanca;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "18,450";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_NT1100_Negra;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "20,000";
                labelCodVeh.Visible = true;
                IdVehiculoL.Visible = true;
                IdVehiculoL.Text = "19";
            }
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_NT1100_Blanca;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "20,000";
