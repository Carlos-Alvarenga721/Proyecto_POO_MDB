...
{
    public partial class carro_honda : FrmBaseModelo
    {
        ...
        private void carro_honda_Load(object sender, EventArgs e)
        {
            //agrego elementos al combobox del modelo
            combomodelo.Items.Clear();
            combomodelo.Items.Add("Honda Civic");
            combomodelo.Items.Add("Honda Accord");
        ...
        private void btnsolicitar_Click(object sender, EventArgs e)
        {
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_civic_rojo;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "25,000";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_civic_azul;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "25,000";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_accord_rojo;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "27,220";
                labelCodVeh.Visible = true;
                IdVehiculoL.Visible = true;
                IdVehiculoL.Text = "11";
            }
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.honda_accord_azul;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "27,220";
