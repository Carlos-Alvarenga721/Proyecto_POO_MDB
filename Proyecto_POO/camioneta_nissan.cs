...
{
    public partial class camioneta_nissan : FrmBaseModelo
    {
        ...
        private void camioneta_nissan_Load(object sender, EventArgs e)
        {
            //agrego elementos al combobox del modelo
            combomodelo.Items.Clear();
            combomodelo.Items.Add("Nissan Frontier NP300");
            combomodelo.Items.Add("Nissan Rogue");
        ...
        private void btnsolicitar_Click(object sender, EventArgs e)
        {
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.nissa_frontier_naranja;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "34,256";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.nissa_frontier_gris;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "34,256";
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.nissa_rogue_naranja;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "40,000";
                labelCodVeh.Visible = true;
                IdVehiculoL.Visible = true;
                IdVehiculoL.Text = "35";
            }
            ...
            {
                Image imagenmoto = Proyecto_POO.Properties.Resources.nissa_rogue_gris;
                Picbox.Image = imagenmoto;
                labelprecio.Visible = true;
                labelmonto.Visible = true;
                labelmonto.Text = "40,000";
